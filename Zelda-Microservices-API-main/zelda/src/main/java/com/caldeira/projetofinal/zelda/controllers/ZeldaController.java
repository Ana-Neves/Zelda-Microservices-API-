...
public class ZeldaController {
    public final ZeldaGatewayService zeldaGatewayService;
    ...
    @GetMapping("/get-all")
    public ResponseEntity<List<GameModel>> getAll(@RequestParam(required = false) Integer page, @RequestParam(required = false) Integer size) {
